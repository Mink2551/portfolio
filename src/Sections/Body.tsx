        ...
        <div className={`lg:w-2/3 mx-auto grid gap-y-4 my-56 ${isVisible ? 'animate-slide-up' : ''}`}>
                ...
                <div className='grid xl:grid-cols-[60%_40%]'>
                    <div className='text-gray-400 grid gap-y-4 mx-3'>
                        <p>Hello, my name is Pacharapol, but you can call me Mink, which is my nickname. Computers are my passion; it's what I love to do in my free time. Currently, <a target='blank' href="https://minkandyanisaprofile.vercel.app/" className='text-primaryP2'>I am 15 years old, born on 03/24/2008</a>, and I am in grade 10, about to finish in one week.</p>
                        ...
                        <p>In terms of software, I've utilized a wide range of programs for basic tasks, and extensively employed Adobe software for school projects. In particular, <a target='blank' href="https://www.facebook.com/sc.satitpm.official?locale=th_TH" className='text-primaryP2'>for my club work</a>, approximately 90% of my editing is done using Lightroom for photo editing, while about 10% involves Premiere Pro for editing videos related to various events.</p>
                        ...
                        <div className='grid grid-cols-2'>
                            ...
                            <div>
                                ...
                                <p><FontAwesomeIcon icon={faArrowRight} className='mr-2 text-primaryP2 animate-pulse'/>Visual studio code </p>
